...
//Librerie VIMEO API
require("/home/juventusnews24.com/htdocs/vimeophp/autoload.php");
...
function register_button($buttons) {
  array_push($buttons, "video_ju24");
  return $buttons;
}

function add_plugin($plugin_array) {
  $plugin_array['video_ju24'] = get_stylesheet_directory_uri().'/js/customcodes.js';
  return $plugin_array;
}
...
wp_enqueue_script( 'video_ju24_js', get_stylesheet_directory_uri().'/js/video_ju24.js' );
function video_ju24($atts, $content = null) {
...
add_shortcode("video_ju24", "video_ju24");
// END Video JS Engine | ARTICOLO


// Sliding Player
function videoslide_ju24($atts, $content = null) {
...
/*
  ...
  if (!isMobileNewtek && homepageURL=="https://www.juventusnews24.com/") {
    var prerollTagSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/juventibus/hp/preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=juventusnews24.com&description_url=juventusnews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var postrollTagSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/juventibus/hp/postroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=juventusnews24.com&description_url=juventusnews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var prerollTagSidebarRepeat = prerollTagSidebar;
    var dfpSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/165059490/Junews24_Preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=juventusnews24.com&description_url=juventusnews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var mediamaticSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/1028390/junews24.TM.preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=juventusnews24.com&description_url=juventusnews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var mediamaticFallbackSidebar = 'https://ad.360yield.com/advast?p=1057026&w=16&h=9';
  } else if (!isMobileNewtek) {
    var prerollTagSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/juventibus/altro/preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=juventusnews24.com&description_url=juventusnews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var postrollTagSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/juventibus/altro/postroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=juventusnews24.com&description_url=juventusnews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var prerollTagSidebarRepeat = prerollTagSidebar;
    var dfpSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/165059490/Junews24_Preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=juventusnews24.com&description_url=juventusnews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var mediamaticSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/1028390/junews24.TM.preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=juventusnews24.com&description_url=juventusnews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var mediamaticFallbackSidebar = 'https://ad.360yield.com/advast?p=1057026&w=16&h=9';
  } else {
    var prerollTagSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/juventibus/mobile/preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=juventusnews24.com&description_url=juventusnews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var postrollTagSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/juventibus/mobile/postroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=juventusnews24.com&description_url=juventusnews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var prerollTagSidebarRepeat = prerollTagSidebar;
    var dfpSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/165059490/Junews24_Preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=juventusnews24.com&description_url=juventusnews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var mediamaticSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/1028390/junews24.TM.preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=juventusnews24.com&description_url=juventusnews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var mediamaticFallbackSidebar = 'https://ad.360yield.com/advast?p=1057026&w=16&h=9';
  ...
  */
  ...
  <!-- Mediamatic | Special - 307x220 | 399 & 398 -->
  <div id='sy_12234' align='center'></div>
  <script>
    ...
    mmTag.push({mmSetPubId:398});
      mmTag.push({mmSetWeight:307});
      mmTag.push({mmSetHeight:220});
      }
    mmTag.push({mmSetDivId:'sy_12234'});
  ...
  add_shortcode("videoslide_ju24", "videoslide_ju24");
  //END Sliding Player
...
// Video Playlist Home
function video_playlist_ju24($atts, $content = null) {
...
add_shortcode("video_playlist_ju24", "video_playlist_ju24");
...
function adv_libs() { ?>
  ...
  if (!isMobileNewtek) {
    googletag.cmd.push(function() {
      ...
      googletag.defineSlot('/67970281/display_thirdparty_it/juventusnews24_responsive/homepage/top_banner', [[728, 90], [980, 250], [1056, 250], [970, 250]], 'div-gpt-ad-1521730756116-2').setTargeting('Display_Ad_Position', ['ATF']).addService(googletag.pubads());
...
<script>
        if (!isMobileNewtek) {
          ...
          jQuery("#div-gpt-ad-1521730756116-1").hide();
        }
      </script>
    </div>
  <?php } else { ?>
    ...
    <div id='div-gpt-ad-1521730852283-1' style='height:1px; width:1px;'>
      <script>
        if (!isMobileNewtek) {
          ...
          jQuery("#div-gpt-ad-1521730852283-1").hide();
        }
      </script>
    </div>
  <?php }
...
<script>
        if (isMobileNewtek) {
          ...
          jQuery("#div-gpt-ad-1521730756116-0").hide();
        }
      </script>
    </div>
  <?php } else { ?>
    ...
    <div id='div-gpt-ad-1521730852283-0'>
      <script>
        if (isMobileNewtek) {
          ...
          jQuery("#div-gpt-ad-1521730852283-0").hide();
        }
      </script>
    </div>
  <?php }
...
function adv_top_mobile() { ?>
  <!-- /67970281/display_thirdparty_it/juventusnews24_responsive/homepage/top_mpu -->
...
function adv_top_mobile_single() {
  if (is_single()) { ?>
    <script type="text/javascript">
    if (isMobileNewtek) {
      top_mobile_content = '<!-- /67970281/display_thirdparty_it/juventusnews24_responsive/ros/top_mpu -->\
...
<script>
        if (isMobileNewtek) {
          ...
          jQuery("#div-gpt-ad-1521730756116-2").hide();
        }
      </script>
    </div>
  <?php } else { ?>
