<?php
/*
Template Name: Radiant 4 HLS Test
*/
?>
<!doctype html >
<!--[if gt IE 8]><!--> <html lang="it-IT" prefix="og: http://ogp.me/ns#"> <!--<![endif]-->
	<head>
		<title>Radiant 4 HLS Test</title>
    <meta charset="UTF-8" />    
...
<div id="SportreviewPlayer"></div>
    ...
    if (!isMobileNewtek) {
      var tagpreroll = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/juventibus/altro/preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=junews24.com&description_url=junews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
      var tagpostroll = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/juventibus/altro/postroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=junews24.com&description_url=junews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
      var tagprerollrepeat = tagpreroll;
    } else {
      var tagpreroll = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/juventibus/mobile/preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=junews24.com&description_url=junews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
      var tagpostroll = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/juventibus/mobile/postroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=junews24.com&description_url=junews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
      var tagprerollrepeat = tagpreroll;
    }
